...
public class DrugsController {
    ...
    static {
        ...
        Drug condom = new Drug();
        condom.setName("Гандоны");
        allDrugs.put(condom, 8);
    ...
    public synchronized void sell(Drug drug, int count) { // renamed to sell to preserve the logic, original name buy
    ...
    public synchronized void buy(Drug drug, int count) { // renamed to buy to preserve the logic, original name sell
